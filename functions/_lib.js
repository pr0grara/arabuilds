...
export const LABELS = {
  ...
  services_want_more: 'Wants more of', services_want_less: 'Wants less of / avoid',
  ...
  proof: 'Trust proof', lead_tracking: 'Lead tracking', estimate_method: 'Estimate method',
  ...
  help_interest: 'Help interested in', involvement_level: 'Involvement level', anything_else: 'Anything else'
};
